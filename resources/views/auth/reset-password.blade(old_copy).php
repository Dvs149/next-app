...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form method="post" action="{{route('password.update')}}">
		...
		<input type="text" id="email" class="fadeIn one" name="email" placeholder="Email">
		<input type="password" id="password" class="fadeIn two" name="password" placeholder="New Password">
